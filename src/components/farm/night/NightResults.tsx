/**
 * The end-of-run card for "האסם בלילה".
 *
...
export default function NightResults({
  ...
  return (
    <div className="absolute inset-0 z-30 grid place-items-center bg-indigo-950/70 p-3">
      <div
        dir="rtl"
        className={`w-full max-w-sm rounded-2xl border-4 border-indigo-950/80 bg-gradient-to-b ${medal.tone} px-4 py-4 text-center shadow-[0_10px_0_rgba(0,0,0,0.35)]`}
      >
